...
/**
* Removes duplicates from a Set s
*/
...
Set Set::difference(Set *X, Set *Y)
{
 ...
 // Allocate memory for arraysPage 15 of 83
 int max = X->getcardinality() > Y->getcardinality() ? X->
 getcardinality() : Y->getcardinality();
...
Set Set::symmetricdifference(Set *X, Set *Y)
{
 ...
 // Allocate memory for arraysPage 16 of 83
 int max = X->getcardinality() > Y->getcardinality() ? X->
 getcardinality() : Y->getcardinality();
